...
function raydiumAmmProgram(params) {
    return new anchor_1.Program(IDL, new web3_js_1.PublicKey("675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8"), params === null || params === void 0 ? void 0 : params.provider, new coder_1.RaydiumAmmCoder(IDL));
}
const IDL = {
    version: "0.3.0",
    name: "raydium_amm",
