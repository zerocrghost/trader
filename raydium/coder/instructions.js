...
function encodeSetParams({ param, value, newPubkey, fees, lastOrderDistance, needTakeAmounts, }) {
    return encodeData({ setParams: { param, value, newPubkey, fees, lastOrderDistance, needTakeAmounts } }, 1 +
        1 +
        1 +
        (value === null ? 0 : 8) +
        1 +
...
function encodeSimulateInfo({ param, swapBaseInValue, swapBaseOutValue }) {
    return encodeData({ simulateInfo: { param, swapBaseInValue, swapBaseOutValue } }, 1 + 1 + 1 + (swapBaseInValue === null ? 0 : 16) + 1 + (swapBaseOutValue === null ? 0 : 16));
}
